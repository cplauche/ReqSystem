...
namespace DAL.Repos
{
    public abstract class ReqUserRepoBase<T> : IDisposable, IReqUserRepo<ReqUser>
    {
        ...
        protected ReqUserRepoBase(DbContextOptions<ApplicationDbContext> options)
        {
