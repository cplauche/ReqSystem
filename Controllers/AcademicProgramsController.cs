...
namespace ReqSystem.Controllers
{
    public class AcademicProgramsController : Controller
    {
        ...
        {
            ViewData["DepartmentId"] = new SelectList(_context.Addresses, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,DepartmentId,Id,TimeStamp")] AcademicProgram academicProgram)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Addresses, "Id", "Id", academicProgram.DepartmentId);
            return View(academicProgram);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Description,DepartmentId,Id,TimeStamp")] AcademicProgram academicProgram)
        {
